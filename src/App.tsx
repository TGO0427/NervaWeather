...
export default function App() {
    ...
    const totals = useMemo(() => {
        ...
        const subtotalFreight = calculateSectionTotal(costs.freight);
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white p-4 rounded-lg shadow-sm sticky top-8">
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between"><span className="text-gray-600">Freight Costs:</span> <span className="font-medium text-gray-800">{formatCurrency(totals.subtotalFreight)}</span></div>
